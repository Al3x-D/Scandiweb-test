    ...
    return (
      <section>
        <button
          ...
          style={btnShow === 'visible' ? { display: 'block' } : { display: 'none' }}
          className={styles.showMenu}>Menu
        </button>

        <button
          style={btnClose === 'hidden' ? { display: 'none' } : { display: 'block' }}
        ...
        <div
          ...
          className={(menu === '' || menu === 'visible') ? styles.menuOpenWrapper : styles.menuWrapper}>
          <ul
            ref={this.menuRef}
            className={styles.menu}
            style={menu === 'hidden' ? { display: 'none' } : { display: 'flex' }}>
